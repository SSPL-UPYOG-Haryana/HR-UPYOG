...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="orderValue"> <spring:message code="purchaseorder.ordervalue"  text="Total/Order Value"/>
	</label>
	<div class="col-sm-3 add-margin">
		<form:input path="orderValue" id="orderValue" cssClass="form-control patternvalidation" disabled="true" data-pattern="decimalvalue" required="required" />
